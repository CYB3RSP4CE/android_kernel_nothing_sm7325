...
if [ -f "$kernel" ] && [ -d "$dts_dir" ]; then
	...
	elif ! git clone https://github.com/xenxynon/AnyKernel3; then
	...
	mkdir -p AnyKernel3/modules/vendor/lib/modules/5.4.288-NetHunter/
	cp $(find out/net/* -name '*.ko') AnyKernel3/modules/vendor/lib/modules/5.4.288-NetHunter/
	cp $(find out/drivers/* -name '*.ko') AnyKernel3/modules/vendor/lib/modules/5.4.288-NetHunter/
	cp out/modules/lib/modules/5.4*/modules.{alias,dep,softdep} AnyKernel3/modules/vendor/lib/modules/5.4.288-NetHunter/
	cp out/modules/lib/modules/5.4*/modules.order AnyKernel3/modules/vendor/lib/modules/5.4.288-NetHunter/modules.load
	cp out/modules/lib/modules/5.4.*/modules.* AnyKernel3/modules/vendor/lib/modules/5.4.288-NetHunter/
	sed -i 's/\(kernel\/[^: ]*\/\)\([^: ]*\.ko\)/\/vendor\/lib\/modules\/\2/g' AnyKernel3/modules/vendor/lib/modules/5.4.288-NetHunter/modules.dep
